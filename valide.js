/* Harnais de validation — Jets de Winnipeg (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'WINNIPEG',
  taille: 24,
  echantillon: {nom: 'Brayden Point', salaire: 9075000, ct: 0, ov: 82},
  masseSousContrat: 32955000,
  nbSousContrat: 9,
  dateSecours: '8 juillet 2026',
  nbEchus: 15,
  nbBackups: 0,
  masseTotale: 104355000
};
...
(async () => {
  ...
  W.localStorage.removeItem('win_resignatures_v1');
  W.localStorage.removeItem('win_transac_v1');
